...
public abstract class EndlessScrollListener implements OnScrollListener {
	...
	private int mVisibleThreshold       = 5;		// Min number of items below current scroll position before loading more
	private int mCurrentPage            = 0;		// Current offset index of data already loaded
	private int mPreviousTotalItemCount = 0;		// Total number of items in the dataset following last load
	private int mStartingPageIndex      = 0;		// Sets starting page index
	private boolean mLoading            = true;		// True if waiting for the last dataset to load
